...
SUCCESS_EXAMPLES = {
    ...
    (
    ...
    ): _success(
        {
            "awayTripCount": 4,
            "awayWinCount": 3,
            "homeAttendanceCount": 5,
            "homeWinRate": 60.0,
            "awayWinRate": 75.0,
            "recent10AttendanceCount": 9,
            "recent10WinRate": 66.67,
            "weekdayStats": [
                {
                    "weekday": "MONDAY",
                    "attendanceCount": 1,
    ...
    ("get", "/api/v1/tour/player-picks", "200"): _list([{
        **PLACE,
        "placeId": "player_pick_001",
        "source": "LOCAL_DATA",
        "sourceContentId": None,
        "isPlayerPick": True,
        "playerPickId": "player_pick_001",
        "stadiumId": "gocheok",
        "recommendedByPlayers": ["홍길동"],
        "recommendedByPlayerPositions": ["INFIELDER"],
